...
<body>
	...
	<div class="row">
		...
		<div class="col-xs-12 col-sm-6 col-md-6" style="margin-top: 10px;">
			<button id="upload_button" type="button"
				...
				data-target="#myModal"
				style="margin-left: 20px; padding-left: 12px; padding-right: 12px;">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Upload an Event
							Poster</h4>
					</div>
						...
						<form class="form-horizontal" role="form"
							...
							<div class="fileinput fileinput-new" data-provides="fileinput"
								...
								<div class="fileinput-preview thumbnail"
									...
									style="width: 100%; max-height: 900px;"></div>
								<div>
							...
							<div class="form-group">
								...
								<div class="dropdown col-sm-9">
									<input type="text" class="datepicker" placeholder="Click me!"
										style="border-width: 1px;" name="date">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputTags"
										placeholder="music, food, art, etc" name="tags">
								</div>
							</div>
							...
							<div class="form-group">
								<label for="inputVenues" class="col-sm-3 control-label">
									Places </label>
								<div class="col-sm-9">
									<input type="text" class="form-control" id="inputVenues"
										placeholder="Where are you hanging this in real life?"
										name="venues">
								</div>
							</div>
    ...
    <div class="col-md-12">
		...
		<div id="container" class="js-masonry" data-masonry-options='{ "columnWidth": 310, "itemSelector": ".item", "isfitwidth": true, "gutter": 10}' style="margin-right:auto;margin-left:auto;">
			...
			<div class="item">
				<a href="#photo<%= (i + 1) %>" data-toggle="modal">
					<img src="<%=imageUrls.get(i)%>"</img>
				</a>

				<!-- Modal -->
				<div class="modal fade" id="photo<%= (i + 1) %>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal"
									aria-hidden="true">&times;</button>
								<h4 class="modal-title" id="myModalLabel">GET EVENT TITLE
									(title)</h4>
							</div>
							<div class="modal-body">
								<img src="<%=imageUrls.get(i)%>" style=""></img> <br />
								<h4>
									<!-- DESCRIPTION OF EVENT (additionalInfo)-->
								</h4>
								<br />
								<h4>
									<!-- ADDRESS (address)-->
